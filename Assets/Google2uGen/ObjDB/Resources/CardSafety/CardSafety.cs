...
{
	[System.Serializable]
	public class CardSafetyRow : IGoogle2uRow
	{
	...
	public class CardSafety :  Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds {
			Pilot_1, Pilot_2, Pilot_3, Pilot_4, ECDIS_1, ECDIS_2, ECDIS_3, Discipline_1, Discipline_2, Discipline_3, Discipline_4, MobilePhone_1, MobilePhone_2, MobilePhone_3, Security_1, Security_2, Security_3, Family_1
			, COLLREG_1, Casualty_1, Cargo_2
		};
		public string [] rowNames = {
			"Pilot_1", "Pilot_2", "Pilot_3", "Pilot_4", "ECDIS_1", "ECDIS_2", "ECDIS_3", "Discipline_1", "Discipline_2", "Discipline_3", "Discipline_4", "MobilePhone_1", "MobilePhone_2", "MobilePhone_3", "Security_1", "Security_2", "Security_3", "Family_1"
			, "COLLREG_1", "Casualty_1", "Cargo_2"
		};
		public System.Collections.Generic.List<CardSafetyRow> Rows = new System.Collections.Generic.List<CardSafetyRow>();
		public override void AddRowGeneric (System.Collections.Generic.List<string> input)
		{
			Rows.Add(new CardSafetyRow(input[0],input[1],input[2],input[3],input[4],input[5],input[6],input[7],input[8],input[9],input[10],input[11],input[12],input[13],input[14],input[15],input[16]));
		}
		...
		public CardSafetyRow GetRow(rowIds in_RowID)
		{
			CardSafetyRow ret = null;
			try
			{
				ret = Rows[(int)in_RowID];
			}
		...
		public CardSafetyRow GetRow(string in_RowString)
		{
			CardSafetyRow ret = null;
			try
			{
