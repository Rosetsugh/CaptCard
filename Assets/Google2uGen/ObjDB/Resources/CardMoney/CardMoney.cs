...
{
	[System.Serializable]
	public class CardMoneyRow : IGoogle2uRow
	{
	...
	public class CardMoney :  Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds {
			Cargo_1, CP_1, CP_2, CP_3, CP_4, CP_5, CP_6, CP_7, CP_8, CP_9, CP_10, CP_11, Blame_1, Blame_2
		};
		public string [] rowNames = {
			"Cargo_1", "CP_1", "CP_2", "CP_3", "CP_4", "CP_5", "CP_6", "CP_7", "CP_8", "CP_9", "CP_10", "CP_11", "Blame_1", "Blame_2"
		};
		public System.Collections.Generic.List<CardMoneyRow> Rows = new System.Collections.Generic.List<CardMoneyRow>();
		public override void AddRowGeneric (System.Collections.Generic.List<string> input)
		{
			Rows.Add(new CardMoneyRow(input[0],input[1],input[2],input[3],input[4],input[5],input[6],input[7],input[8],input[9],input[10],input[11],input[12],input[13],input[14],input[15],input[16]));
		}
		...
		public CardMoneyRow GetRow(rowIds in_RowID)
		{
			CardMoneyRow ret = null;
			try
			{
				ret = Rows[(int)in_RowID];
			}
		...
		public CardMoneyRow GetRow(string in_RowString)
		{
			CardMoneyRow ret = null;
			try
			{
