...
{
	[System.Serializable]
	public class CardKnowledgeRow : IGoogle2uRow
	{
	...
	public class CardKnowledge :  Google2uComponentBase, IGoogle2uDB
	{
		public enum rowIds {
			Radar_1, Radar_2, Radar_3, Radar_4, Radar_5, Radar_6, Meteo_1, Meteo_2, Meteo_3, Meteo_4, Meteo_5, Meteo_6, Nav_1, Nav_2, Nav_3, Nav_4, Nav_5, Buoy_1
			, Buoy_2, Buoy_3, Buoy_4, Buoy_5, SMCP_1, SMCP_2, COLLREG_1, COLLREG_2, COLLREG_3, COLLREG_4, COLLREG_5, COLLREG_6, COLLREG_7, Passage_1, Passage_2, Passage_3, ECDIS_1, ECDIS_2, ECDIS_3, IMDG_1
			, IMDG_2, IMDG_3, IMDG_4, IMDG_5, Maneuvering_1, Maneuvering_2
		};
		...
		public System.Collections.Generic.List<CardKnowledgeRow> Rows = new System.Collections.Generic.List<CardKnowledgeRow>();
		public override void AddRowGeneric (System.Collections.Generic.List<string> input)
		{
			Rows.Add(new CardKnowledgeRow(input[0],input[1],input[2],input[3],input[4],input[5],input[6],input[7],input[8],input[9],input[10],input[11],input[12],input[13],input[14],input[15],input[16]));
		}
		...
		public CardKnowledgeRow GetRow(rowIds in_RowID)
		{
			CardKnowledgeRow ret = null;
			try
			{
				ret = Rows[(int)in_RowID];
			}
		...
		public CardKnowledgeRow GetRow(string in_RowString)
		{
			CardKnowledgeRow ret = null;
			try
			{
